...
<html>
	<head>
		...
		<title>Spare Change Cycling, <decorator:title/></title>

		<meta name="description" content="<decorator:getProperty property="meta.description" default="Spare Change Cycling is a place to buy and sell used bikes, bike parts, and bike acccessories."/>"/>
